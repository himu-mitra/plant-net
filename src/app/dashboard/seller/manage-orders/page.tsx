            ...
            <table className="min-w-full border-collapse w-full">
              <thead>
                <tr className="bg-emerald-600 text-white">
                  ...
                  <th className="px-2 py-3 text-left text-sm font-medium">Customer</th>
                  <th className="px-2 py-3 text-left text-sm font-medium">Price</th>
                  <th className="px-2 py-3 text-left text-sm font-medium">Quantity</th>
                  ...
                  <th className="px-2 py-3 text-left text-sm font-medium">Action</th>
                </tr>
              </thead>
              <tbody>
